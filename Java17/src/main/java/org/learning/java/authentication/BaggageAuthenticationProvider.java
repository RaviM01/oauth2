...
@Slf4j
public class BaggageAuthenticationProvider implements AuthenticationProvider {
    private static final String ERROR_URI = "https://datatracker.ietf.org/doc/html/rfc6749#section-3.2.1";
    private final RegisteredClientRepository registeredClientRepository;

    public BaggageAuthenticationProvider(RegisteredClientRepository registeredClientRepository) {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        log.info("BaggageAuthenticationProvider -> authenticate");
        BaggageAuthenticationToken deviceClientAuthentication =
                (BaggageAuthenticationToken) authentication;
        ...
        return new BaggageAuthenticationToken(registeredClient,
                deviceClientAuthentication.getClientAuthenticationMethod(), null);
    }

    @Override
    public boolean supports(Class<?> authentication) {
        return BaggageAuthenticationToken.class.isAssignableFrom(authentication);
    }
